...
import {useRef, useEffect, useReducer, Reducer, ReducerAction, useCallback} from 'react';
...
// Reducer Action 정의 후 interface로  타입지정
...
const TicTacToe = () => {
    ...
    useEffect(() => {
        ...
        if(win) {
            ...
            tableData.forEach((row) => {    // tableData의 빈칸검사
                row.forEach((cell) => {
                    if(!cell) {
                        all = false;
                    }
